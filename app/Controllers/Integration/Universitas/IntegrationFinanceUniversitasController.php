...
class IntegrationFinanceUniversitasController extends BaseController
{
  ...
  public function Index()
  {
    ...
    $group = "02"; // 01 = Yayasan, 02 = Unika, 03 = Rumah Sakit
  ...
  public function getPendapatanTahun($monthYEAR_req, $group_req)
  {
    ...
    $total = 0;
    foreach ($getList->getResult() as $list) {
      $excludeCOA = array("4303019", "4103009");
  ...
  public function getLiabilitasJangkaPendek($monthYEAR_req, $group_req)
  {
    ...
    FROM
		  ...
		  INNER JOIN [StagingData].[dbo].[AJ_GL_BALANCES_V] AS glbalance ON glcodecombinations.CODE_COMBINATION_ID = glbalance.CODE_COMBINATION_ID 
	  WHERE 
      glcodecombinations.SEGMENT5 IN ('2102001', '2102002', '2102998', '2102999', '2103001', '2103002', '2103003', '2103005', '2103006', '2103007', '2103008', '2103009', '2104001', '2104002', '2104003', '2105001', '2105004', '2105006', '2106001', '2106002', '2106004', '2106005', '2106006', '2106007', '2106008', '2106009', '2106010', '2106011', '2106012', '2106013', '2106014', '2106015', '2106997', '2107001', '2107003', '2107004', '2107005', '2107006', '2107007', '2107008', '2109001')
      and glcodecombinations.SEGMENT1='" . $group . "' 
      and glbalance.PERIOD_NAME= '" . $period . "' 
      and glbalance.ACTUAL_FLAG= 'A'
    GROUP BY
  ...
  public function getCapex($monthYEAR_req, $group_req)
  {
    ...
    $group  = $group_req;      //01 = Yayasan, 02 = Unika
    $period = $monthYEAR_req;  // JAN-18
    if ($group_req == 01) { $groupName = "Yayasan "; } elseif ($group_req == 02) { $groupName = "UNIKA "; } elseif ($group_req == 03) { $groupName = "RUMAH SAKIT "; } else { $groupName = ""; }
