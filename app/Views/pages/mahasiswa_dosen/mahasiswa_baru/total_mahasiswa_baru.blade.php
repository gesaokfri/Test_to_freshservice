<div class="row">
    <div class="col-lg-4 align-self-center">
        ...
        <div class="d-flex">
            <span class="fst-italic mx-auto mt-3 mb-0">Grafik fakultas mahasiswa baru</span>
        </div>
    </div>
    <div class="col-lg-8 mt-3 align-self-center">
                ...
                <div class="card hoverable p-3 pb-0 h-100" style="background: #f3f3f37a; cursor: default;">
                    ...
                    <div class="d-flex mt-2 gap-3">
                        ...
                        <div class="bg-light p-1 rounded" style="background: #e1e1e1 !important">
                            <span class="align-self-end ms-1" style="margin-top: 2px">{{  number_format(intval($item['jumlah_mahasiswa'])/intval($totalJumlahMahasiswaBaru)*100, 2, '.', ',') }}%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4 mt-3">
                <div class="card hoverable p-3 pb-0 h-100" style="background: #ffbc902d; cursor: default;">
                    ...
                    <div class="d-flex mt-2 gap-3">
                        ...
                        <h5 class="align-self-center ms-2 mb-0 fw-bold">{{ int_to_rp($totalJumlahMahasiswaBaru) }}</h5>
        ...
        <div class="d-flex mt-4">
            ...
            <h5 class="mb-0 align-self-center">{{ int_to_rp($totalJumlahTargetMahasiswaBaru) }}</h5>
        </div>
    </div>
</div>
