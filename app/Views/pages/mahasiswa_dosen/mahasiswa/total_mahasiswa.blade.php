<div class="row">
    <div class="col-lg-4 align-self-center">
        <div id="total_mahasiswa_chart" class="apex-charts hoverable" dir="ltr"></div>
        <div class="d-flex">
            <span class="fst-italic mx-auto mt-3 mb-0">Grafik mahasiswa seluruh fakultas</span>
        </div>
    </div>
    <div class="col-lg-8 align-self-center">
            <div class="row">
                @foreach ($dataCardMahasiswa as $item)
                    ...
                    <div class="col-sm-4 mt-3" data-toggle="tooltip" data-placement="left" data-bs-html="true" title="
