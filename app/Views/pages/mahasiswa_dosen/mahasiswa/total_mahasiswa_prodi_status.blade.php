<div class="row">
    <div class="col-lg-4 align-self-center">
        ...
        <div class="d-flex">
            <span class="fst-italic mx-auto mt-3 mb-0">Grafik prodi dan status mahasiswa</span>
        </div>
    </div>
                ...
                <div class="card hoverable p-3 pb-0" style="background: #f3f3f37a; cursor: default;">
                    ...
                    <div class="d-flex mt-2 gap-3">
                        ...
                        <div class="bg-light p-1 rounded" style="background: #e1e1e1 !important">
                            <span class="align-self-end ms-1" style="margin-top: 2px">{{ (empty($totalJumlahMahasiswaProdi) ? "0" : number_format(intval($item['JmlMhs'])/intval($totalJumlahMahasiswaProdi)*100, 2, '.', ',')) }}%</span>
                        </div>
                    </div>
                </div>
            </div>
