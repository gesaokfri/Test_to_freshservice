...
<form id="form-import_markom" method="POST" autocomplete="off">
  {!! csrf_field() !!}
	...
	<table>
		...
		<tr>
			<td colspan="2"><br/>
				- Download sample import <a href="{{base_url('import/sample/xls/sample_marketingkompetitor_import.xls')}}" style="color:blue;cursor:pointer;" download>click here</a><br/>
...
<script type="text/javascript">
    function save_import(){
    	action("form-import_markom", "Import Marketing/Kompetitor", "Apakah anda ingin import data marketing/kompetitor ?", "warning", 'marketing_kompetitor/import_save',refresh,'toast');
    }
    ...
    function import_review(){
		if( document.getElementById("excel_file_markom").files.length == 0 ){
			...
			$.ajax({
				url : 'marketing_kompetitor/import_preview',
				type : 'post',
				dataType : 'html',
