  ...
  @if($filter_type=="tahun")
      ...
      <tbody>
            ...
            <tr>
              ...
              <td class="text-end">
              @php
              if ($item["real"][$i] < 1 && $item["real"][$i]  > 0) {
                echo number_format(round($item["real"][$i]/1000000000, 2));
              } else {
                echo round($item["real"][$i]/1000000000);
              }
              @endphp
              </td>
              @endfor
           ...
           @endforeach
            ...
            <tr>
              <td>% {{ $item["name"] }}</td>
                ...
                <td class="text-end">
                  @php
                  if ($item["persen"][$i] < 1 && $item["persen"][$i]  > 0) {
                    echo number_format(round($item["persen"][$i], 2));
                  } else {
                    echo round($item["persen"][$i]);
                  }
                  @endphp %
                </td>
                @endfor
      ...
      <tbody>
            ...
            <tr>
              ...
              if ($item["real"][$i] < 1 && $item["real"][$i]  > 0) {
                ...
                echo number_format(round($item["real"][$i]/1000000000));
              }
              @endphp
              </td>
              @endfor
