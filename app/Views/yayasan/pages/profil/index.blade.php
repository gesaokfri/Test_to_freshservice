...
@section('script')
    <script>
        ...
        $("#form-edit-profil").on("submit", function(event){
            ...
            action("form-edit-profil", "Ubah Profil", "Apakah anda yakin untuk menyimpan perubahan?", "warning", '{{ base_url("yayasan/profile/update") }}', refresh);
            
        });

        $("#form-edit-password").on("submit", function(event){
            event.preventDefault();
            action("form-edit-password", "Ubah Password", "Apakah anda yakin untuk menyimpan perubahan?", "warning", '{{ base_url("yayasan/profile/update_password") }}', refresh);
