<div id="chart_investasi" class="apex-charts" dir="ltr"></div>
<table class="table table-hover table-sm mt-3">
  ...
  <tbody>
        @foreach ($tableInvestasi as $item)
            <tr>
            <td>{{ $item["name"] }}</td>
      ...
      <tr>
          <td>Jumlah</td>
          @php
              if (count($tableInvestasi[0]["data"]) > 4) {
                  for ($i = 1; $i <= 5; $i++) {
...
<script>
    ...
    document.querySelector("#chart_investasi"),
    options
    );
