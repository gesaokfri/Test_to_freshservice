        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{base_url('')}}/assets/images/design/logo/logo.png" alt="" height="50">
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ base_url('universitas/profile') }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-logout">Profil</span></a>
